  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <div className="text-center">
          <div className={`w-28 h-28 sm:w-32 sm:h-32 mx-auto rounded-full flex items-center justify-center ${
            ...
            <div className="text-white">
              ...
              <div className="text-xs sm:text-sm">/9</div>
            </div>
          </div>
      ...
      <div className="mt-6 text-center border-t border-gray-200 pt-6 w-full">
        <p className="text-sm sm:text-base text-gray-600 min-w-0 break-words results-min-text">
        ...
        <p className="mt-1 text-xs sm:text-sm text-gray-500 break-words fda-banner-text">
