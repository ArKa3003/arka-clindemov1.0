...
This tool SUPPORTS but does NOT replace clinical judgment. The final decision regarding patient care rests solely with the qualified healthcare provider.`,
  ...
  // Criterion compliance checklist
  CRITERIA: {
    criterion1: {
      title: 'Data Input Criterion',
      status: 'COMPLIANT',
      description: 'Analyzes clinical indications, NOT medical images or device signals',
    },
    criterion2: {
    ...
    criterion3: {
      ...
      status: 'COMPLIANT',
      description: 'Provides recommendations to healthcare professionals, not directives',
    },
    criterion4: {
  ...
  // What this tool does NOT do (for clarity)
  EXCLUSIONS: [
  ...
  // For PDF, print, and copy-to-clipboard outputs
