...
function generateClinicalJustification(
  ...
  text += `AIIE Appropriateness Score: ${appropriatenessScore.value}/9\n`;
  text += `Category: ${appropriatenessScore.category}\n\n`;
  text += `AIIE Evidence: ${matchedCriteria.source}\n`;
...
function generateCDSConsultationSummary(
  ...
  summary += `- AIIE Evidence: ${matchedCriteria.source}\n`;
  ...
  summary += `Generated by ARKA Imaging Intelligence Engine (AIIE) Clinical Decision Support\n\n`;
  summary += `${FDA_COMPLIANCE.PRINT_AND_COPY_DISCLAIMER}\n`;
